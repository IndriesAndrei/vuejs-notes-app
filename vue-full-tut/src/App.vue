...
// initial state of a note is empty note
const newNote = ref("");

// show error if note text less than 10 characters
const errorMessage = ref("");

// initial state of notes is empty array of notes
const notes = ref([]);

// get light random colors for notes background-color
